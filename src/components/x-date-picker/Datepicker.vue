...
export default {
    ...
    props: {
        ...
        /** 类型 date time datetime range rangetime */
        type: {
            type: String,
            default: 'date',
        },
    ...
    methods: {
        ...
        refreshCalendars(refresh = false) {
            ...
            if (this.calendarIndex == 0) {
                if (refresh) {
                    this.calendars.splice(0, 1, DateTools.getCalendar(date, this.procCalendar));
                }
                ...
                if (refresh) {
                    this.calendars.splice(1, 1, DateTools.getCalendar(date, this.procCalendar));
                }
                ...
                if (refresh) {
                    this.calendars.splice(2, 1, DateTools.getCalendar(date, this.procCalendar));
                }
            }
